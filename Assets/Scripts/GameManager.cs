...
public class GameManager : MonoBehaviour
{
    ...
    private void StartGame()
    {
        ...
        // 자동차 생성
        var _carController = Instantiate(carPrefab, new Vector3(0, 0, -3f), Quaternion.identity)
            .GetComponent<CarController>();
        
        // left, right move button에 자동차 컨트롤 기능 적용
        leftMoveButton.OnMoveButtonDwon += () => _carController.Move(-1f);
        rightMoveButton.OnMoveButtonDwon += () => _carController.Move(1f);
    }
